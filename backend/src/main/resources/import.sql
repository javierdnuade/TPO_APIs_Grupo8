...
-- Creditos
INSERT INTO creditos (id, dni_cliente, deuda_original, fecha, importe_cuota, cantidad_cuotas, estado) VALUES
  (1, '30111222', 120000.00, DATE '2026-01-15', 10000.00, 12, FALSE),
  (2, '28999111', 60000.00, DATE '2026-02-10', 10000.00, 6, FALSE),
  (3, '33444555', 90000.00, DATE '2026-03-05', 15000.00, 6, FALSE);
...
INSERT INTO cobranzas (id, id_credito, id_cuota, importe, fecha) VALUES
  (1, 1, 1, 10000.00,'2026-04-25'),
  (2, 1, 2, 20000.00,'2026-05-25'),
  (3, 2, 1, 5000.00,'2026-06-20');
